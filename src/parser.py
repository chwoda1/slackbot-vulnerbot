...
class Data_Grabber:
        ...
        for keys in stuff['CVE_Items']:
            ...
            if keywords[1] != None:
                ...
                if keys['impact'] != {}:
                    ...
                    if keywords[1].upper() in keys['impact']['baseMetricV2']['severity']:
                       holder = self.grab_data(holder,keys)
    ...
    def grab_data(self , holder , keys):
       ...
       container = {'description':description,'manufacturer':manufac,'product':product}
